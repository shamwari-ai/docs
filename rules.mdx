...
sidebarTitle: "The two rules"
description: "Everything else in Shamwari is a preference. These two are constraints, enforced in more than one place, because each is the kind of claim that is worthless the first time it turns out not to be true."
---
